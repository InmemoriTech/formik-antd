...
var FormItem = function (_a) {
    var name = _a.name, __debug = _a.__debug, showValidateSuccess = _a.showValidateSuccess, _b = _a.showInitialErrorAfterTouched, showInitialErrorAfterTouched = _b === void 0 ? false : _b, children = _a.children, validate = _a.validate, restProps = tslib_1.__rest(_a, ["name", "__debug", "showValidateSuccess", "showInitialErrorAfterTouched", "children", "validate"]);
    return (React.createElement(formik_1.Field, { name: name, validate: validate }, function (_a) {
        ...
        var error = (0, formik_1.getIn)(errors, name, undefined);
        var initialError = (0, formik_1.getIn)(initialErrors, name, undefined);
        var isTouched = (0, formik_1.getIn)(touched, name, false);
        ...
        return (React.createElement(antd_1.Form.Item, tslib_1.__assign({ htmlFor: name, id: name, name: name, validateStatus: hasError || (hasInitialError && !isTouched)
                ? 'error'
